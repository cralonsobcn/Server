...
# CONTROLPLANE_IP="192.168.1.230"  # defined in kubeadm-config.yaml
# POD_CIDR="10.244.0.0/16" # defined in kubeadm-config.yaml
...
# Installs nerdctl-full. https://github.com/containerd/nerdctl/releases/tag/v2.1.2
wget https://github.com/containerd/nerdctl/releases/download/v2.1.2/nerdctl-full-2.1.2-linux-amd64.tar.gz
sudo tar Cxzvvf ~/.local nerdctl-full-2.1.2-linux-amd64.tar.gz
rm nerdctl-full-2.1.2-linux-amd64.tar.gz
bash ~/.local/bin/containerd-rootless-setuptool.sh install
